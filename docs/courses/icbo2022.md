...
TBD | Introduction to OBO, its community, principles, resources, and best practices | James Overton
TBD | Hands-on lesson in basic tools: ontology browsers, how to contribute to ontologies via GitHub (creating issues and making Pull Requests), and the Protege ontology editor | Nicole Vasilevsky 
TBD | Introduction to ROBOT | Becky Jackson 
