...
The tutorial content can also be tested with [SPARQLPrompt](https://github.com/twhetzel/sparql-chrome-extension), a Chrome Extension for use with the yasgui site. An OpenAI API Key is needed for this tool.
