...
Now download the seed-my-repo wrapper script from the ODK GitHub repository. A detailed explanation of how to do that can be found [here](../howto/odk-create-repo/). For simplicity, we just use wget here to download the seed-my-repo file, but you can do it manually:
