...
1. Go to the pull request on GitHub, and click on the "Files Changed" tab up top
2. Find the file you want to edit in the pull request.
3. On the right, click on on the three `...`, and then "Edit file". 
...
4. Do the edits, and then commit changes, usually to the same branch
